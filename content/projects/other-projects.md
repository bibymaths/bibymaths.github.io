...
### 1. Early Work & Snippets  

A collection of small Perl scripts for bioinformatics and algorithmic practice, covering sequence analysis, string manipulation, alignment, motif search, and classic problems (e.g., Fibonacci, Tower of Hanoi).

Not a standalone research project, but an early codebase that reflects foundational scripting and problem-solving.  

[GitHub](https://github.com/bibymaths/perl_snippets)
 
### 2. Poster: Docking for Schizophrenia

<embed src="/images/posters/nscsb2016.pdf" type="application/pdf" width="100%" height="600px" />

A conference poster presented by **Abhinav Mishra** & Nimisha Asati at the **16th NSCB Symposium (JUIT, Solan)** under the **Department of Biotechnology & Bioinformatics**, showcasing a **docking-based approach** to identify potential lead molecules targeting the dopamine **D3 receptor** in schizophrenia.  

[GitHub](https://github.com/bibymaths/poster_nscb16) 

### 3. Poster: FM-Index for Error-Tolerant Sequence Search  
