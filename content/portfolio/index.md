...
- **Research Intern** — Institute for Biology, HU Berlin *(Jan 2025 – Feb 2025)*  
  ...
  [GitHub](https://github.com/matthiaskoenig/tirzepatide-model)

- **Master Thesis Student** — Theoretical Biophysics, HU Berlin *(May 2024 – Jan 2025)*  
  ...
  [GitHub](https://github.com/bibymaths/phoskintime)

- **Bachelor Thesis Student** — JUIT, India *(Feb 2016 – Mar 2017)*  
  Designed a pipeline using GEO2R, MeV, WB-DEGS, and R/Shiny to identify and validate prostate cancer biomarkers.  
  [GitHub](https://github.com/bibymaths/bachelor_thesis)

- **Project Researcher** — JUIT, India *(Aug 2015 – Mar 2016)*  
...
See [Projects](https://bibymaths.github.io/projects/) for details.
...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  ...
  <img src="https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/gnu.svg" alt="GNU Make" height="40" style="background-color:#A42E2B; padding:4px; border-radius:6px;" />
